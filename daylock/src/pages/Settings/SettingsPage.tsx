...
export function SettingsPage() {
  ...
  const handleResetData = () => {
    ...
    useGymStore.setState({ workoutHistory: [] });
              ...
              <div className="px-4 py-3 space-y-3">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-1.5 rounded-lg bg-status-danger text-white text-xs font-semibold hover:bg-opacity-90 transition-opacity"
                  >
                    Reset
                  </button>
                </div>
